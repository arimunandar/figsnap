      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            '**An image fill becomes a flat placeholder colour.** The fill points at a file inside Figma that nothing outside can fetch, so the box would otherwise be a hole. The comment above the rule says so.',
          ],
        },
